...
Был добавлен модуль для чтения операций из файлов CSV и XLSX.
...
### csv_xlsx_reader
```python
from csv_xlsx_reader import read_from_file

print(read_from_file("transactions.csv", sep=';'))
```
```
Вывод кода: 
[{'id': 650703, 'state': 'EXECUTED', 'date': '2023-09-05T11:30:32Z', 'amount': 16210.0, 'currency_name': 'Sol', 'currency_code': 'PEN', 'from': 'Счет 58803664561298323391', 'to': 'Счет 39745660563456619397', 'description': 'Перевод организации'}]
```
